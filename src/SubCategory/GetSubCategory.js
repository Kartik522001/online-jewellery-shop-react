    ...
    return (
        <div>
            ...
            <div className="content-wrapper card-body table-resposive col-md-10">
                ...
                <Link to="/admin/addsubcategory" className="btn btn-info float-right">
                    Add Sub-Category
                </Link>
                            ...
                            return (
                                <tr>
                                    ...
                                    <td><button onClick={() => DeleteData(subcategory._id)} className='btn btn-danger'>DELETE</button>
                                        ...
                                        <Link to={`/admin/getsubcategory/updatecategory/${subcategory._id}`} className="btn btn-primary">UPDATE</Link>
                                    </td>
                                </tr>
                            );
                        })}
