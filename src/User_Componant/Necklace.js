...
const Necklace = () => {
    ...
    const getData = async () => {
        await axios.get(`http://localhost:4001/productslist/625ea4cf1e55c44683917b6a`).then((res) => {
            console.log(res.data.data);
            setproductList1(res.data.data);
        });
    };
    const getData1 = async () => {
        await axios.get(`http://localhost:4001/productslist/625ea5591e55c44683917b70`).then((res) => {
            console.log(res.data.data);
            setproductList2(res.data.data);
        });
    };
    const getData2 = async () => {
        await axios.get(`http://localhost:4001/productslist/625ea6041e55c44683917b76`).then((res) => {
            console.log(res.data.data);
                ...
                <div className="row pb-3">
                    <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                        <div class="card product-item border-0 mb-4">
                            ...
                            <div class="card-footer d-flex justify-content-between bg-light border">
                                <Link to={`/detail/625ea4cf1e55c44683917b6a`} class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>View Detail</Link>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                        <div class="card product-item border-0 mb-4">
                            ...
                            <div class="card-footer d-flex justify-content-between bg-light border">
                                <Link to={`/detail/625ea5591e55c44683917b70`} class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>View Detail</Link>
                                <Link to="" class="btn btn-sm text-dark p-0"><i class="fas fa-shopping-cart text-primary mr-1"></i>Add To Cart</Link>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                        <div class="card product-item border-0 mb-4">
                            ...
                            <div class="card-footer d-flex justify-content-between bg-light border">
                                <Link to={`/detail/625ea6041e55c44683917b76`} class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>View Detail</Link>
                                <Link to="" class="btn btn-sm text-dark p-0"><i class="fas fa-shopping-cart text-primary mr-1"></i>Add To Cart</Link>
                            </div>
                        </div>
                    </div>
