...
const Home = () => {
    ...
    const getData = async () => {
        await axios.get(`http://localhost:4001/productslist/62546438ac3b2caa532954a2`).then((res) => {
    ...
    const getData2 = async () => {
        await axios.get(`http://localhost:4001/productslist/625d8f3616722bf5556cc28a`).then((res) => {
            console.log(res.data.data);
