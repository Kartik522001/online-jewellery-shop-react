...
const Bracelet = () => {
    ...
    const getData = async () => {
        await axios.get(`http://localhost:4001/productslist/625ea23d1e55c44683917b32`).then((res) => {
            console.log(res.data.data);
            setproductList1(res.data.data);
        });
    };
    const getData1 = async () => {
        await axios.get(`http://localhost:4001/productslist/625ea2f71e55c44683917b38`).then((res) => {
            console.log(res.data.data);
            setproductList2(res.data.data);
        });
    };
    const getData2 = async () => {
        await axios.get(`http://localhost:4001/productslist/625ea3991e55c44683917b3e`).then((res) => {
            console.log(res.data.data);
                ...
                <div className="row pb-3">
                    <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                        <div class="card product-item border-0 mb-4">
                            ...
                            <div class="card-footer d-flex justify-content-between bg-light border">
                                <Link to={`/detail/625ea23d1e55c44683917b32`} class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>View Detail</Link>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                        <div class="card product-item border-0 mb-4">
                            ...
                            <div class="card-footer d-flex justify-content-between bg-light border">
                                <Link to={`/detail/625ea2f71e55c44683917b38`} class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>View Detail</Link>
                                <Link to="" class="btn btn-sm text-dark p-0"><i class="fas fa-shopping-cart text-primary mr-1"></i>Add To Cart</Link>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                        <div class="card product-item border-0 mb-4">
                            ...
                            <div class="card-footer d-flex justify-content-between bg-light border">
                                <Link to={`/detail/625ea3991e55c44683917b3e`} class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>View Detail</Link>
                                <Link to="" class="btn btn-sm text-dark p-0"><i class="fas fa-shopping-cart text-primary mr-1"></i>Add To Cart</Link>
                            </div>
                        </div>
                    </div>
