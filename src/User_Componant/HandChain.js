...
const HandChain = () => {
    ...
    const getData = async () => {
        await axios.get(`http://localhost:4001/productslist/625ea6c91e55c44683917b89`).then((res) => {
            console.log(res.data.data);
            setproductList1(res.data.data);
        });
    };
    const getData1 = async () => {
        await axios.get(`http://localhost:4001/productslist/625ea7791e55c44683917b8f`).then((res) => {
            console.log(res.data.data);
            setproductList2(res.data.data);
        });
    };
    const getData2 = async () => {
        await axios.get(`http://localhost:4001/productslist/625ea8181e55c44683917b95`).then((res) => {
            console.log(res.data.data);
                ...
                <div className="row pb-3">
                    <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                        <div class="card product-item border-0 mb-4">
                            ...
                            <div class="card-footer d-flex justify-content-between bg-light border">
                                <Link to={`/detail/625ea6c91e55c44683917b89`} class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>View Detail</Link>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                        <div class="card product-item border-0 mb-4">
                            ...
                            <div class="card-footer d-flex justify-content-between bg-light border">
                                <Link to={`/detail/625ea7791e55c44683917b8f`} class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>View Detail</Link>
                                <Link to="" class="btn btn-sm text-dark p-0"><i class="fas fa-shopping-cart text-primary mr-1"></i>Add To Cart</Link>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                        <div class="card product-item border-0 mb-4">
                            ...
                            <div class="card-footer d-flex justify-content-between bg-light border">
                                <Link to={`/detail/625ea8181e55c44683917b95`} class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>View Detail</Link>
                                <Link to="" class="btn btn-sm text-dark p-0"><i class="fas fa-shopping-cart text-primary mr-1"></i>Add To Cart</Link>
                            </div>
                        </div>
                    </div>
